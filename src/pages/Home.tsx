...
function PricingCard({
  ...
  return (
    <div className={`flex h-full min-h-[520px] flex-col rounded-3xl border p-8 transition-all ${isDisabled
      ...
      <Button
        className={`mt-7 w-full font-bold ${isDisabled ? 'pointer-events-none opacity-60' : ''}`}
    ...
    <span className="text-base font-medium leading-relaxed text-slate">
      ...
      <Section className="border-b border-border bg-[#f8f7f6]">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <div className="mt-8 flex max-w-3xl items-center gap-4">
